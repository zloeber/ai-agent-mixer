# Synthetic AI Conversation Orchestrator - Technical Summary & Purpose
...
│  ├─ Configuration Manager (YAML import/export)             │
...
│  ├─ Agent A Connection (Configurable URL/Model)            │
│  └─ Agent B Connection (Configurable URL/Model)            │
└─────────────────────────────────────────────────────────────┘
```
